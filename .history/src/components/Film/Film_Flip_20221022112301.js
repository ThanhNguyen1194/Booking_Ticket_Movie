...
export default function Film_Flip(props) {
    ...
    return (
        <div className="flip-card mt-2 mb-2">
            ...
            }} className="bg-orange-300 text-center cursor-pointer py-2 my-2 text-success-50 font-bold hover:bg-green-400 transition-all transition-transform" style={{ borderRadius: "10px" }}>ĐẶT VÉ</div>
        </div>
