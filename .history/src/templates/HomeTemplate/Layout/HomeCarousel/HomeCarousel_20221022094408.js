...
import hinhAnh from './img/banTayDietQuy.jpg'
    ...
    const renderImg = () => {
        return arrImg.map((item, index) => {
            return <div key={index}>
                <div style={{ ...contentStyle, backgroundImage: `url(${"./img/banTayDietQuy.jpg"})` }}>
                    <img src="./img/banTayDietQuy.jpg" className="opacity-0" alt={"./img/banTayDietQuy.jpg"} />
                </div>
