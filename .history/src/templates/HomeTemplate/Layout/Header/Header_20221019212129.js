        ...
        <header className="p-4 bg-coolGray-100 text-coolGray-800 bg-opacity-40 bg-black text-white fixed w-full z-10" >
            <div className="container flex justify-between h-16 mx-auto text-lg">
                ...
                <ul className="items-stretch hidden space-x-3 lg:flex">
                    <li className="flex">
                        <NavLink to="/home" className="flex items-center -mb-0.5 border-b-2 px-4 border-transparent  text-white" activeClassName="border-b-2  border-violet-300 text-violet-300">Home</NavLink>
                    </li>
                    {/* <li className="flex">
                    ...
                    <li className="flex">
                        <NavLink to="/profile" className="flex items-center -mb-0.5 border-b-2 px-4 border-transparent text-white" activeClassName="border-b-2 border-violet-300 text-violet-300">Profile</NavLink>
                    </li>
                    {/* <li className="flex">
