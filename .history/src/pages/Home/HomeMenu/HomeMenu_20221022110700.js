                                            ...
                                            <div className="ml-2">
                                                ...
                                                <div className="grid grid-cols-6 gap-6" >
                                                    {phim.lstLichChieuTheoPhim?.slice(0, 12).map((lichChieu, index) => {
                                                        return <NavLink className="text-2xl text-green-400 px-5" style={{ border: "2px solid rgb(74,222,128)", borderRadius: "10px" }} to={`/checkout/${lichChieu.maLichChieu}`} key={index}>
